...
"""),_display_(Seq(/*8.2*/main/*8.6*/ {_display_(Seq(format.raw/*8.8*/("""
    ...
    """),_display_(Seq(/*12.6*/form(routes.Application.save,'enctype -> "multipart/form-data")/*12.69*/ {_display_(Seq(format.raw/*12.71*/("""
	    ...
	    <input type="hidden" name="cattag" value=""""),_display_(Seq(/*35.49*/controllers/*35.60*/.Application.rndInt(1000))),format.raw/*35.85*/("""" />
...
"""))}
    ...
    def ref = this
                ...
                /*
                    ...
                    HASH: 8539ef134d773f3b05a7fae79fcb14fe4d624554
                    MATRIX: 513->1|618->43|650->67|724->21|753->41|781->116|814->120|825->124|858->126|927->165|999->228|1034->230|1116->281|1183->326|1228->340|1448->538|1503->563|1572->610|1617->624|1690->675|1736->690|1960->892|2041->942|2061->953|2108->978|2310->1149|2325->1155|2366->1174|2452->1229|2490->1236
